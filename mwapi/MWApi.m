...
- (MWApiResult *)uploadFile:(NSString *)filename withFilepath:(NSString *)filepath text:(NSString *)text comment:(NSString *)comment {
    ...
    filename = (filename != nil)? filename: [[filepath lastPathComponent] stringByDeletingPathExtension];
    ...
    NSURLRequest *uploadRequest = [builder buildRequest:@"POST" withFilename:filename withFilePath:filepath];
