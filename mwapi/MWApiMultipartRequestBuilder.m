...
-(NSData *)dataToUpload:(NSString *)filename withFilepath:(NSString *)filepath
{
    ...
    [uploadBodyData appendData:[NSData dataWithContentsOfFile:filepath]];
...
- (NSURLRequest *) buildRequest:(NSString *)requestType withFilename:(NSString *)filename withFilePath:(NSString *)filepath
{
    ...
    [body appendData:[self dataToUpload:filename withFilepath:filepath]];
